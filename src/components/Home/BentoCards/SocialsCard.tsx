...
const socials = [
  ...
  },
  {
    name: 'LinkedIn',
    icon: Linkedin,
    link: 'https://www.linkedin.com/in/vikas387/',
    translateX: '12px',
    rotate: '-10deg',
    zIndex: 1,
  },
  ...
  },
  {
    name: 'Spotify',
    icon: Spotify,
    link: 'https://open.spotify.com/user/3135chhsws3d66dsoxgqosgqkzvy',
    translateX: '-12px',
    rotate: '10deg',
    zIndex: 1,
  },
  {
    name: 'YouTube',
    icon: YT,
    link: 'https://www.youtube.com/@luffy1399',
    translateX: '-24px',
    rotate: '20deg',
    zIndex: 0,
  },
